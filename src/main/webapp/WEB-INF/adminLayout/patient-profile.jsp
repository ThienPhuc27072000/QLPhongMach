                ...
                <div class="col-md-4 col-xs-12">
                    <div class="white-box">
                        ...
                        <c:forEach items="${patients}" var="d">
                            <div id="${d.id}" class="user-btm-box" >
                                <!-- .row -->
                                <div class="row text-center m-t-10">
                                    <div class="col-md-6 b-r"><strong>Name</strong>
                                        <p>${d.ho}Jonathan Doe</p>
                                    </div>
                                ...
                                <!-- .row -->
                                <div class="row text-center m-t-10">
                                    <div class="col-md-6 b-r"><strong>Gender</strong>
                                        <p>${d.gioiTinh}jondoe@gmail.com</p>
                                    </div>
                                    <div class="col-md-6"><strong>Phone</strong>
                                        <p>${d.dienThoai}+123 456 789</p>
                                    </div>
                                </div>
                                <!-- /.row -->
                                <hr>
