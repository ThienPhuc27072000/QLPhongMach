        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Edit medicine</h4> </div>
                    ...
                    <div class="white-box">
                        ...
                        <form:form modelAttribute="medicine" method="post" cssClass="form-material form-horizontal">
                            <div class="form-group">
                                <label class="col-md-12" for="example-text">Tên thuốc</span>
                                </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-12" for="example-text">Đơn giá</span>
                                </label>
                                <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="col-md-12" for="example-text">Đơn vị</span>
                                </label>
                                <div class="col-md-12">
