        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="text-contant">
                    <h2>
                        <span class="center"><span class="icon"><img src="<c:url value = "/images/icon-logo.png"/>" alt="#" /></span></span>
...
<div id="about" class="section wow fadeIn">
    <div class="container">
        <div class="heading">
            <span class="icon-logo"><img src="<c:url value = "/images/icon-logo.png"/>" alt="#"></span>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="post-media wow fadeIn">
                    <img src="<c:url value = "/images/about_03.jpg"/>" alt="" class="img-responsive">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        ...
                        <img src="<c:url value = "/images/clinic_02.jpg"/>" alt="" class="img-responsive">
                    </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
                        <a href="images/clinic_01.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="<c:url value = "/images/clinic_01.jpg"/>" alt="" class="img-responsive">
                    </div>
                    <h3>Digital Control Center</h3>
                </div>
                <!-- end service -->
            ...
            <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                <div class="inner-services">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                            <span class="icon-service"><img src="<c:url value = "/images/service-icon1.png"/>" alt="#" /></span>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                            <span class="icon-service"><img src="<c:url value = "/images/service-icon2.png"/>" alt="#" /></span>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                            <span class="icon-service"><img src="<c:url value = "/images/service-icon3.png"/>" alt="#" /></span>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                            <span class="icon-service"><img src="<c:url value = "/images/service-icon4.png"/>" alt="#" /></span>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                            <span class="icon-service"><img src="<c:url value = "/images/service-icon5.png"/>" alt="#" /></span>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                            <span class="icon-service"><img src="<c:url value = "/images/service-icon6.png"/>" alt="#" /></span>
        ...
        <div class="row dev-list text-center">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
                <div class="widget clearfix">
                    <img src="<c:url value = "/images/doctor_01.jpg"/>" alt="" class="img-responsive img-rounded">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn;">
                <div class="widget clearfix">
                    <img src="<c:url value = "/images/doctor_02.jpg"/>" alt="" class="img-responsive img-rounded">
                    <div class="widget-title">
                        <h3>Bryan Saftler</h3>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                <div class="widget clearfix">
                    <img src="<c:url value = "/images/doctor_03.jpg"/>" alt="" class="img-responsive img-rounded">
                    <div class="widget-title">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                <div class="testimonial clearfix">
                    ...
                    <div class="testi-meta">
                        <img src="<c:url value = "/images/testi_01.png"/>" alt="" class="img-responsive alignleft">
            ...
            <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                <div class="testimonial clearfix">
                    ...
                    <div class="testi-meta">
                        <img src="<c:url value = "/images/testi_02.png"/>" alt="" class="img-responsive alignleft">
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                <div class="testimonial clearfix">
                    ...
                    <div class="testi-meta">
                        <img src="<c:url value = "/images/testi_03.png"/>" alt="" class="img-responsive alignleft">
